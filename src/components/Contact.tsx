const Contact = () => {
  const controlInputs = (type: string, name: string, placeholder: string) => {
    const containerStyle = type === "textarea" ? "sm:col-span-2" : "";
    return (
          ...
          <div className="p-10">
            <form action="#" method="POST">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-5 gap-y-4">
                {controlInputs("text", "name", "Your Name")}
                {controlInputs("email", "email", "Your Email")}
                {controlInputs("textarea", "message", "Your Message")}
